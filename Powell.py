...
servers = {
    'UNREAL BOXING 1': '191.96.93.16',
    'streetboxing  1': 'play.streetboxing.net',
        ...
        if response.status_code == 200:
            ...
            if player_data:
                ...
                if discord_id:
                    ...
                    gif_url = "https://cdn.discordapp.com/attachments/1306917667726168159/1308036472829513748/lounki-gojo.gif?ex=673c7b65&is=673b29e5&hm=e0c135d9d1ca0eaa2065fc9a291c6c022eee9fe96e39e56842e36a3d8de319c9&"
                    embed.set_image(url=gif_url)

                    embed.set_footer(text=f"ค้นหาข้อมูลโดย {channel.guild.name}", icon_url=channel.guild.icon.url)
                    embed.set_author(name="FiveM Player Checker BY Powellstyle", icon_url="https://cdn.discordapp.com/attachments/1204028119615275048/1308016697143332904/464853357_1067701665362637_894224694344380734_n.jpg?ex=673c68fa&is=673b177a&hm=9e8d9c10a309e8de6fbd3ee9e6fa7960bb85dbe68fdc59f57a714784331ee06d&")
...
async def check(ctx, player_id: str):
    ...
    embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/1204028119615275048/1308050702844563466/1e.gif?ex=673c88a5&is=673b3725&hm=21dfc1676be0bbd8ce4755f9daad197102858f856832971f07a6930525b1b030&")
...
bot.run('MTMwODAyNzQxMTE4MjM4NzIwMQ.GYv9Ci.1YksXY0mIyXuL5oVNDnySgTDsxGXXuRqI3-60k')